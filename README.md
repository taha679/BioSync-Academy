# 🧬 BioSync-Academy
### **Official Repository for the e-ICON World Contest 16 (2026)**
**Representing Morocco 🇲🇦 | SDG 3: Good Health and Well-being**

---

## 👥 The Architect

<table border="1" style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; font-size: 15px; text-align: center;">
    <thead style="background-color: #1a1a1a; color: white;">
        <tr>
            <th style="padding: 10px;">👤 Role</th>
            <th style="padding: 10px;">Med Taha Hayati <br>(Lead Programmer & Architect)</th>
        </tr>
    </thead>
    <tbody>
        <tr>
